...
export function SalesFilterBar({
    ...
    >
      ...
      <select value={filters.payment} onChange={(event) => onChange({ ...filters, payment: event.target.value })}>
      ...
      <select value={filters.menuName} onChange={(event) => onChange({ ...filters, menuName: event.target.value })}>
